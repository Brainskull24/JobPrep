...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Original Array counters: " + Arrays.toString(counters));
...
//        arr = new Student[5];
        ...
        // List.of() method with primitives
        int[] intArr = { 10, 20, 15, 22, 35 };
        System.out.println("Integer Array as List: " + List.of(intArr)); // [[I@66a29884]
        ...
        int[] original = {1, 2, 3};
        int[] clone = original.clone(); // shallow copy for primitives
        System.out.println("Cloned Array: " + Arrays.toString(clone));
        System.out.println("Are they same reference? " + (original == clone));

        int[] nums = {5, 9, 1, 7, 3};
        Arrays.parallelSort(nums);
        System.out.println("Parallel Sorted: " + Arrays.toString(nums));

        int[] ar = {1, 2, 3, 4, 5};
        int sum = Arrays.stream(ar).sum();
        double avg = Arrays.stream(ar).average().orElse(0);
        ...
        // List → Array
        String[] newArr = list1.toArray(new String[0]);
